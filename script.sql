...
-- COLOCANDO ALGUNS MOCKS DE Usuario ---------------------

INSERT INTO T_USUARIO (ID_USUARIO,NM_USUARIO,NR_IDADE_USUARIO) 
    VALUES (usuario_seq.NEXTVAL,'Maria de Fátima',18);

INSERT INTO T_USUARIO (ID_USUARIO,NM_USUARIO,NR_IDADE_USUARIO) 
    VALUES (usuario_seq.NEXTVAL,'Carlos Alberto',30);

INSERT INTO T_USUARIO (ID_USUARIO,NM_USUARIO,NR_IDADE_USUARIO) 
    VALUES (usuario_seq.NEXTVAL,'Renato Lorenzo',58);